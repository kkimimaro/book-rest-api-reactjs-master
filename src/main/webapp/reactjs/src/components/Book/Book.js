...
class Book extends Component {
  ...
  findAllLanguages = () => {
    ...
    setTimeout(() => {
      ...
      if (bookLanguages) {
        this.setState({
          languages: [{ value: "", display: "Выберите язык" }].concat(
  ...
  findAllGenres = () => {
    ...
    setTimeout(() => {
      ...
      if (bookGenres) {
        this.setState({
          genres: [{ value: "", display: "Выберите жанр" }].concat(
      ...
      <div>
        ...
        <Card className={"border border-dark bg-dark text-white"}>
          <Card.Header>
            ...
            {this.state.id ? "Изменить книгу" : "Добавить книгу"}
          </Card.Header>
          <Form
            ...
            <Card.Body>
              ...
              <Form.Row>
                ...
                <Form.Group as={Col} controlId="formGridISBNNumber">
                  <Form.Label>Код ISBN</Form.Label>
                  <Form.Control
                    required
                    autoComplete="off"
                    type="test"
                    ...
                    onChange={this.bookChange}
                    className={"bg-dark text-white"}
                    placeholder="Введите ISBN код книги..."
                  />
                </Form.Group>
              </Form.Row>
              <Form.Row>
