...
public class BookResourceImpl implements Resource<Book> {
	...
	public  ResponseEntity<Set<String>> findAllLanguages() {
        return new ResponseEntity<>(new TreeSet<>(Arrays.asList("Французский", "Португальский", "Английский", "Русский", "Японский", "Арабский", "Испанский", "Китайский")), HttpStatus.OK);
    }

    @GetMapping("/genres")
    public  ResponseEntity<Set<String>> findAllGenres() {
        return new ResponseEntity<>(new TreeSet<>(Arrays.asList("Манга", "Наука", "История", "Фэнтези", "Биография", "Хоррор", "Романтика")), HttpStatus.OK);
    }
}
